...
public class PlayerStats {
    ...
    public PlayerStats() {
        this.unitStats = new Dictionary<byte, Stats>() {
            { EntityType.SWORDSMAN, new Stats(hp: 75, attack: 8, upgradedAttack: 0, range: 2, fieldOfView: 20, swordArmor: 1, arrowArmor: 0, upgradedSwordArmor: 0, upgradedArrowArmor: 0, level: 0) },
            { EntityType.SPEARMAN, new Stats(hp: 55, attack: 9, upgradedAttack: 0, range: 3, fieldOfView: 20, swordArmor: 0, arrowArmor: 0, upgradedSwordArmor: 0, upgradedArrowArmor: 0, level: 0) },
            { EntityType.ELITE_SWORDSMAN, new Stats(hp: 80, attack: 14, upgradedAttack: 0, range: 2, fieldOfView: 20, swordArmor: 2, arrowArmor: 2, upgradedSwordArmor: 0, upgradedArrowArmor: 0, level: 0) },
