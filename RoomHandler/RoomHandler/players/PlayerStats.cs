...
public class PlayerStats {
    ...
    public PlayerStats() {
        this.unitStats = new Dictionary<byte, Stats>() {
            ...
            { EntityType.GUARD_TOWER, new Stats(hp: 2350, attack: 5, upgradedAttack: 0, range: 10, fieldOfView: 60, swordArmor: 0, arrowArmor: 0, upgradedSwordArmor: 0, upgradedArrowArmor: 0, level: 0) },
