...
public static class SizeMapping {
    private static Dictionary<byte, Size> mapping = new Dictionary<byte, Size> {
        ...
        { EntityType.GOLD_MINE, new Size(4, 4) },
        { EntityType.STONE_MINE, new Size(4, 4) },
        { EntityType.TREE_TYPE1, new Size(2, 2) },
        { EntityType.TREE_TYPE2, new Size(2, 2) },
        { EntityType.TREE_TYPE3, new Size(2, 2) },
